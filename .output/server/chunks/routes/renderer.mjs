...
import { q as joinRelativeURL, u as useRuntimeConfig, t as getResponseStatusText, v as getResponseStatus, w as defineRenderHandler, x as getQuery, j as createError, y as getRouteRules, z as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"key":"keywords","name":"keywords","content":"Podcast, youtube, Ypod"},{"key":"robots","name":"robots","content":"index, follow"},{"key":"author","name":"author","content":"Vova Stelmashchuk"}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"},"title":"Ypod - Youtube playlist to podcast RSS"};
